<template>
  <v-container style="max-width: 1150px">
    <v-row>
      <v-col cols="12" sm="9" class="px-0 py-sm-0 px-lg-0">
        <h2>Sobre os Serviços:</h2>
        <v-expansion-panels accordion flat>
          <v-expansion-panel>
            <v-expansion-panel-header>
              <h3>1 - O que exatamente você vende?</h3>
            </v-expansion-panel-header>
          ...
          <v-expansion-panel class="bb">
            <v-expansion-panel-header>
              <h3>3 - Você trabalha com materiais impressos?</h3>
            </v-expansion-panel-header>
            <v-expansion-panel-content>
              <p>Sim. Consulte os valores dos materiais impressos.</p>
            </v-expansion-panel-content>
          </v-expansion-panel>
        </v-expansion-panels>
      </v-col>
      ...
      <v-col cols="12" sm="9" class="px-0">
        <h2 class="pt-5">Sobre Identidade Visual:</h2>
        <v-expansion-panels accordion flat>
          <v-expansion-panel>
            <v-expansion-panel-header>
              <h3>4 - O que é Identidade Visual?</h3>
            </v-expansion-panel-header>
            <v-expansion-panel-content>
              <p>
                É um conjunto de elementos que representam de forma visual uma
                empresa, uma pessoa, um serviço ou um evento. Formado por cores,
                tipografia e formas específicas, a Identidade Visual tem como
                elemento central o logotipo, que pode servir de base para todos
                os materiais.
              </p>
            </v-expansion-panel-content>
          </v-expansion-panel>
          <v-expansion-panel>
            <v-expansion-panel-header>
              <h3>5 - Por que eu deveria ter uma Identidade Visual?</h3>
            </v-expansion-panel-header>
            <v-expansion-panel-content>
              <p>
                ...
                etc. Abaixo listo 8 motivos pelo qual você deve investir em
              ...
              <ol>
                ...
                <li>
                  ...
                  tornam irrelevantes. O design ajuda na pregnância e na
          ...
          <v-expansion-panel>
            <v-expansion-panel-header>
              <h3>6 - Qual a diferença entre Logotipo e Identidade Visual?</h3>
            </v-expansion-panel-header>
            <v-expansion-panel-content>
              <p>
                Logotipo é apenas um elemento gráfico que representa sua
                empresa. O projeto de Identidade Visual é muito mais completo
                pois envolve, além do logotipo, uma série de elementos que vão
                dar personalidade para sua marca como cores, tipografia, ícones,
                texturas, padrões, entre outras possibilidades. Além disso, a
                identidade visual considera os pontos de contato, bem como todo
                o universo visual da marca. Também considera o momento atual da
                empresa e onde ela quer chegar, considerando variáveis e
                abrangências.
              </p>
            </v-expansion-panel-content>
          </v-expansion-panel>
          <v-expansion-panel>
            <v-expansion-panel-header>
              <h3>7 - O que acontece em caso de reprovação?</h3>
            </v-expansion-panel-header>
            <v-expansion-panel-content>
              <p>
          ...
          <v-expansion-panel>
            <v-expansion-panel-header>
              <h3>8 - Como é o processo criativo?</h3>
            </v-expansion-panel-header>
            <v-expansion-panel-content>
              <p>
          ...
          <v-expansion-panel>
            <v-expansion-panel-header>
              <h3>9 - Quais são os arquivos que recebo?</h3>
            </v-expansion-panel-header>
            <v-expansion-panel-content>
              <p>
          ...
          <v-expansion-panel>
            <v-expansion-panel-header>
              <h3>10 - Como o projeto será apresentado?</h3>
            </v-expansion-panel-header>
            <v-expansion-panel-content>
              <p class="mb-2">
                O projeto é apresentado em um arquivo PDF, organizado da
                seguinte forma:
              </p>
              <ul>
                <li>Desafio;</li>
          ...
          <v-expansion-panel>
            <v-expansion-panel-header>
              <h3>11 - Quantas opções de logo irei receber?</h3>
            </v-expansion-panel-header>
            <v-expansion-panel-content>
              <p>
          ...
          <v-expansion-panel>
            <v-expansion-panel-header>
              <h3>
                12 - Se eu já tiver o logotipo pronto, você faz apenas os
                materiais?
              </h3>
            </v-expansion-panel-header>
            <v-expansion-panel-content>
          ...
          <v-expansion-panel>
            <v-expansion-panel-header>
              <h3>13 - Recebo os materiais impressos do projeto?</h3>
            </v-expansion-panel-header>
            <v-expansion-panel-content>
              <p>
      ...
      <v-col class="px-0 pt-5 pb-0" cols="12" sm="9">
        <p>
          Fico feliz que meu trabalho tenha lhe despertado interesse. Caso tenha
